...
void NonMaxSuppressionFilter::ApplyToRegion(int startx, int endx, int starty, int endy, const vector<IImage *> &inputs,
...
void NonMaxSuppressionFilter::Setup(const vector<IImage *> &inputs, const vector<IImage *> &outputs) {
