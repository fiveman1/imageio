...
public:
     ...
     * this filter has.
     */
    virtual void Apply(const vector<IImage*>& inputs, const vector<IImage*>& outputs) {
...
protected:
     ...
     * @param outputs: variable amount of outputs
     */
    virtual void ApplyInternal(const vector<IImage*>& inputs, const vector<IImage*>& outputs) = 0;
